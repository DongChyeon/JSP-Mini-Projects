...
<sql:setDataSource var="dataSource"
	...
	driver="com.mysql.jdbc.Driver" user="root" password="Youare2485!" />
	...
	<div class="container">
		<form name="newMember" class="form-horizontal"
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input name="id" type="text" class="form-control" placeholder="아이디" value="<c:out value='${row.id }'/>" >
				</div>
			</div>
			<div class="form-group  row">
				<label class="col-sm-2">비밀번호</label>
				<div class="col-sm-3">
					<input name="password" type="text" class="form-control" placeholder="비밀번호" value="<c:out value='${row.password }'/>" >
				</div>
			</div>
			<div class="form-group  row">
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input name="name" type="text" class="form-control" placeholder="성명" value="<c:out value='${row.name }'/>" >
				</div>
			</div>
			<div class="form-group  row">
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input name="phone" type="text" class="form-control" placeholder="전화번호" value="<c:out value='${row.phone}'/>">
				</div>
			</div>
			...
			<div class="form-group  row">
				...
				<div class="col-sm-5">
					<input name="address" type="text" class="form-control" placeholder="주소" value="<c:out value='${row.address}'/>">
				</div>
			</div>
			<div class="form-group  row">
